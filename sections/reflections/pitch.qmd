...
My portfolio's "brand theme" is inspired by femininity, philosophy and the art nouveau movement of the early 20^th^ century. Using these styling elements, my goal is to build several mini-interconnected projects utilizing R with a dash of [MySQL](https://services.gvsu.edu/TDClient/60/Portal/KB/?CategoryID=462){target="_blank"} .
...
-   [County Health Rankings](http://www.countyhealthrankings.org/){target="_blank"}
-   [Walkability Scores](https://edg.epa.gov/metadata/catalog/main/home.page){target="_blank"}
